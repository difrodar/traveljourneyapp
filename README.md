...
- **Abgrenzung [Optional]:** Login und private Benutzerbereiche sind umgesetzt, jedoch ohne Rollenmodell, E-Mail-Verifikation oder Passwort-Reset. Keine echten Einladungsnachrichten, kein Chat und kein Bild-Upload. Bildmaterial wird nur über optionale URLs referenziert, damit Urheberrecht und Storage-Komplexität im Prototyp kontrollierbar bleiben.

...
- **Commit-Praxis:** Conventional-Commit-ähnliches Schema mit Type-Präfix nach Bereich:
  ...
  - Nach dem Usability-Test trägt jeder Commit, der ein Issue schliesst, dieses Issue im Titel-Suffix (`… (#NN)`) und im Body einen `Closes #NN`-Trailer, sodass GitHub die Issues beim Push automatisch schliesst.
